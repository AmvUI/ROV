...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/ardanto14/ROV/src/pid)
  set(pid_DEVEL_PREFIX /home/ardanto14/ROV/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/ardanto14/ROV/install)
...
if(NOT "/home/ardanto14/ROV/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ardanto14/ROV/src/pid/${idir}'.  ${_report}")
    endif()
