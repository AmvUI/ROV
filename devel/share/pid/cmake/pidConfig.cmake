...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/nathan/ROV/src/pid)
  set(pid_DEVEL_PREFIX /home/nathan/ROV/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/nathan/ROV/install)
...
if(NOT "/home/nathan/ROV/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nathan/ROV/src/pid/${idir}'.  ${_report}")
    endif()
