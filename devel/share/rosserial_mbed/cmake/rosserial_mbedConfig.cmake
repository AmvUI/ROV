...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_mbed_SOURCE_PREFIX /home/ardanto14/ROV/src/rosserial/rosserial_mbed)
  set(rosserial_mbed_DEVEL_PREFIX /home/ardanto14/ROV/devel)
  ...
  set(rosserial_mbed_INSTALL_PREFIX /home/ardanto14/ROV/install)
...
if(NOT "/home/ardanto14/ROV/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ardanto14/ROV/src/rosserial/rosserial_mbed/${idir}'.  ${_report}")
    endif()
