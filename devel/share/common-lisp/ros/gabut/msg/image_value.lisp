...
(cl:defclass <image_value> (roslisp-msg-protocol:ros-message)
  ((state_red
    :reader state_red
    :initarg :state_red
    :type cl:fixnum
...
(cl:defclass image_value (<image_value>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <image_value>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'image_value)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gabut-msg:<image_value> is deprecated: use gabut-msg:image_value instead.")))

(cl:ensure-generic-function 'state_red-val :lambda-list '(m))
(cl:defmethod state_red-val ((m <image_value>))
...
(cl:defmethod state_blue-val ((m <image_value>))
...
(cl:defmethod blue_crack-val ((m <image_value>))
  ...
  (blue_crack m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <image_value>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <image_value>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<image_value>)))
  "Returns string type for a message object of type '<image_value>"
  "gabut/image_value")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'image_value)))
  "Returns string type for a message object of type 'image_value"
  "gabut/image_value")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<image_value>)))
  "Returns md5sum for a message object of type '<image_value>"
  "ad9f5988e975c9e2128f2a0d58a5bb28")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'image_value)))
  "Returns md5sum for a message object of type 'image_value"
  "ad9f5988e975c9e2128f2a0d58a5bb28")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<image_value>)))
  "Returns full string definition for message of type '<image_value>"
  (cl:format cl:nil "int16 state_red~%int16 state_blue~%int16 blue_crack~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'image_value)))
  "Returns full string definition for message of type 'image_value"
  (cl:format cl:nil "int16 state_red~%int16 state_blue~%int16 blue_crack~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <image_value>))
  (cl:+ 0
     2
     2
     2
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <image_value>))
